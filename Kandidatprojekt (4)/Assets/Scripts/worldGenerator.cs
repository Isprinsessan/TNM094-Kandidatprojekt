...
public class worldGenerator : NetworkBehaviour
{
    ...
    */
    ...
    public bool hasSpawnedWorld = false;
        ...
        if (isObjectTerrain == true)
        {
            ...
            if (Physics.Raycast(rayPos, Vector3.down, out hit, Mathf.Infinity, groundLayer))
            {
                ...
                if (objectsHit.Length == 0)
                {
                    ...
                    terrainObject.transform.parent = theWorld.transform;

                    NetworkServer.Spawn(terrainObject);
        ...
        else
        {
            ...
            if (Physics.Raycast(rayPos, Vector3.down, out hit, Mathf.Infinity, groundLayer))
            {
                ...
                if (objectsHit.Length == 0)
                {
                    ...
                    worldObject.transform.parent = theWorld.transform;
